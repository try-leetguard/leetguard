...
export default function DashboardTermsPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <header className="border-b border-gray-200 pt-16 bg-white">
        <div className="max-w-4xl mx-auto px-6 py-8">
          <div className="flex items-center mb-4">
            <Link
              href="/settings/data"
              className="flex items-center text-black hover:text-gray-700 transition-colors duration-200"
            >
      ...
      {/* Content */}
      <main className="max-w-4xl mx-auto px-6 py-8 overflow-y-auto">
