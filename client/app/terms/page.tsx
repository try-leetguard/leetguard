            ...
            <div className="space-y-8">
              ...
              <section>
                <div className="bg-[#F9F6F0] border border-black rounded-lg p-6 mb-6">
                  <p className="text-black leading-relaxed">
                    ...
                    ("LeetGuard," "we," "us," or "our"), provides its services
                    (the "Service") to you through its website located at
                    www.leetguard.com (the "Site") and related services
                    (collectively, the "Services"), subject to the following
                    Terms of Service ("Terms"). We may update these Terms from
                    time to time in accordance with the section titled
                    "Modifications" below. Your continued use of the Service
              ...
              <section>
                ...
                <p className="text-black leading-relaxed mb-6">
                  LeetGuard provides software tools aimed at helping users
                  improve focus and productivity by blocking distracting
                  websites and applications during specified sessions. We offer
                ...
                <p className="text-black leading-relaxed">
                  ...
                  without notice. Material changes will be communicated via
                  email or on the Site and will take effect at the next
                  subscription renewal unless immediate changes are necessary to
                  comply with law or protect security.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-black leading-relaxed mb-6">
                  You may need to register for an account to access some
                  features. You agree to provide accurate, current, and complete
                  information and to update it promptly as necessary. You must
                  be at least 13 years old to use the Service, or older if
                ...
                <p className="text-black leading-relaxed">
                  ...
                  information and for all activities under your account. You
              ...
              <section>
                ...
                <p className="text-black leading-relaxed mb-6">
                  ...
                  content that violates laws, infringes on intellectual
                ...
                <p className="text-black leading-relaxed">
                  By submitting User Content, you grant LeetGuard a
                  non-exclusive, worldwide, royalty-free license to use, host,
                  store, reproduce, and display such content solely to provide
                  the Service.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-black leading-relaxed">
                  ...
                  including software, trademarks, logos, and content, are owned
                  by LeetGuard or its licensors. You may not copy, modify,
              ...
              <section>
                ...
                <p className="text-black leading-relaxed">
                  ...
                  violate these Terms or for other reasons. Upon termination,
                  your right to use the Service ends, but provisions intended to
